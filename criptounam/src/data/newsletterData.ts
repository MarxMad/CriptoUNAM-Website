...
*   [Stellar Blog](https://stellar.org/blog)`
  ...
  {
    "id": "pumax402-stellar-hackathon",
    "titulo": "Construímos un sistema de pagos para agentes de IA en Stellar y esto es lo que aprendí",
    "autor": "Edgadafi",
    "fecha": "2026-04-20",
    "imagen": "/images/newsletter/pumax402-stellar-hackathon.png",
    "tags": [
      "Stellar",
      "Web3",
      "Hackathon",
    ...
    "contenido": "# Construímos un sistema de pagos para agentes de IA en Stellar\n\nHay momentos en los que estás en medio de algo y no tienes certeza de si va a funcionar. Tienes el código corriendo, los logs pasan frente a tus ojos, y de repente ves la línea que lo confirma todo:\n\nHTTP 402 → firma automática → pago USDC en Stellar → HTTP 200\n\nUn agente de IA acaba de pagar solo. Sin que yo hiciera nada. En menos de 5 segundos. Ese fue el momento en que supe que lo que estábamos construyendo era real.\n\n## Por qué me metí a esto\n\nTodo empezó con una pregunta: ¿cómo paga un agente de IA por los servicios que necesita? Un humano abre una cuenta, ingresa su tarjeta, se suscribe. Un agente no puede hacer nada de eso. No tiene identidad legal. No tiene RFC. No puede firmar un contrato.\n\nEl protocolo **x402** cambia eso. Cuando un agente pide información a un servidor, el servidor responde con HTTP 402 — Pago Requerido — junto con las instrucciones. El agente firma la transacción automáticamente con su wallet de Stellar y reintenta. Sin cuentas. Sin suscripciones. Sin humano intermediario.\n\n## Por qué Stellar\n\nLos fees de red son de $0.00001 por transacción. En muchas otras blockchains, el costo del gas superaría el valor del micropago mismo. Stellar tiene USDC nativo, liquidación en ~5 segundos, y el facilitador de OpenZeppelin que cubre los fees automáticamente.\n\n## Qué construímos : PumaX402\n\nParticipar en **Stellar Hacks: Agents 2026** en DoraHacks fue el detonador — un hackathon global con $10,000 USD y más de 261 equipos. En cinco semanas construímos **PumaX402**: un hub de servicios x402 en Stellar que permite a cualquier agente de IA descubrir, pagar y consumir APIs de inteligencia de forma autónoma.\n\nEl sistema tiene tres capas: el **catálogo** (directorio público de servicios con UI y API REST), el **cliente MCP** (conecta con Claude y Cursor, maneja el ciclo de pago automáticamente), y los **servicios propios de inteligencia**:\n\n*   *Energy Signal:* precio del petróleo WTI/Brent + señal IA (BUY/SELL/HOLD) + impacto en tipo de cambio LATAM\n*   *Geopolitical Risk:* score de riesgo geopolítico 0-100 para LATAM, Golfo Pérsico y Europa\n*   *Stellar DEX Signal:* señales del mercado del DEX nativo de Stellar\n*   *Agent Pulse:* estado de la red para contexto antes de ejecutar operaciones\n\nPrecio por consulta: $0.001 a $0.10 USDC. Sin cuenta. Sin contrato.\n\n## El momento que cambió todo\n\nCursor Agent preguntó algo → MCP detectó que necesitaba datos → GET /v1/pulse → recibió HTTP 402 → firmó automáticamente con la wallet de Stellar → pagó USDC en testnet, transacción real on-chain → recibió el JSON → Cursor respondió al usuario. El humano no vio ningún pago. El agente lo manejó solo.\n\n## Por qué esto importa para México y LATAM\n\nCon el petróleo a $120/barril, el tipo de cambio del peso está bajo presión. Un CFO en Guadalajara que compra materias primas no tiene acceso a análisis en tiempo real — Bloomberg Terminal cuesta $24,000 USD al año. PumaX402 cambia eso: por $0.10 de USDC, cualquier agente consulta ese análisis sin cuenta, sin contrato. Democratización real de información financiera. Desde México.\n\n## Lo que sigue\n\nEl hub está en producción. El repo es público. El MCP se instala en Cursor con cinco líneas. La Stellar Development Foundation, Amazon, Google, Mastercard y Visa acaban de unirse a la x402 Foundation. Stellar maneja el 65% de todas las transacciones x402 del mundo. México puede ser parte de esta infraestructura desde el principio.\n\n### Recursos\n*   [Repositorio PumaX402](https://github.com/MarxMad/Agenticx402)\n*   [Hub en vivo](https://agenticx402-production.up.railway.app)\n*   [Protocolo x402](https://x402.org)\n*   [Stellar Developers](https://developers.stellar.org/docs/build/apps/x402)"
  }
]
